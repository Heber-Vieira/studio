...
// FIX: Force redirection to Dashboard for Staff/Admins upon login
// This ensures that if they logged out from another view, they don't land back there.
useEffect(() => {
  if (user && user.role !== 'client' && !initialParams.isBooking) {
